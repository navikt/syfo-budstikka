# 0015: Ledervarsel-`oppgavetype` som lukket, budstikka-eid enum

**Dato:** 2026-07-17
**Status:** Godkjent
**Beslutningstakere:** Team eSyfo
**Relatert:** issue #108 (Ledervarsel-producer), ADR 0016 (ledervarsel in-app-only), B1 (domeneblind), B23 (anti-corruption), B30 (merkelapp = lukket enum), B9 (typede value-class-identifikatorer), epic #15
...
- [x] Beslutningen dokumenteres i denne ADR-en; B-registeret er frosset ved B1–B63 (#165), nye varige valg får ikke B-numre — @grillmester
