# 0016: Ledervarsel-kanal er in-app-only — drop `externalVarsling`, korriger B25

**Dato:** 2026-07-17
**Status:** Godkjent
**Beslutningstakere:** Team eSyfo
**Relatert:** issue #108 (Ledervarsel-producer), #24 (Arbeidsgivervarsel), ADR 0015 (oppgavetype), B6 (kanal pr. hendelse), B23 (anti-corruption), B24 (NL-resolusjon), B25 (sendevindu), B32 (AG-mottaker inkl. NarmesteLeder), B40 (falsk affordance), epic #15
...
4. **Korriger B25:** «ledervarsel m/ekstern» strykes fra listen over eksternbærende
   leveranser. Dokumenteres i denne ADR-en (B-registeret er frosset ved B1–B63, #165).
...
- [x] Beslutningen (korrigerer B25) dokumenteres i denne ADR-en; B-registeret er frosset ved B1–B63 (#165) — @grillmester
