...
/**
 * B7/B8, ADR 0009: controls external notification and letter fallback for a Brukervarsel CREATE
 * based on whether its recipient can receive a digital notification (KRR, [ReservationLookup]).
 */
