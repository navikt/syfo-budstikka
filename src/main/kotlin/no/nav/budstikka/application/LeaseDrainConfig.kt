 ...
 * `application`; parsing fra `application.conf` bor i `infrastructure.task.config` slik at
 * workerne ikke avhenger av Ktor-config. En framtidig cleanup-task bærer et retensjonsvindu (ikke
