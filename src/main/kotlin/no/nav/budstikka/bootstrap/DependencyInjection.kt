...
import no.nav.budstikka.infrastructure.metrics.MicrometerRetentionCleanupMetrics
...
internal fun Application.installDependencyInjection(overrides: DependencyRegistry.() -> Unit = {}) {
    ...
    dependencies {
        ...
        provide<RetentionCleanupMetrics> { MicrometerRetentionCleanupMetrics(resolve<PrometheusMeterRegistry>()) }
        databaseModule()
