...
3. Review NAV-konsekvenser av `accessPolicy` og auth-mekanisme med `/nav-architecture-review`; registrer via `/domain-modeling` bare når valget passerer alle tre ADR-testene.
