...
description: "Create focused Kotest integration tests with real adapters, PostgresTestFixture, Flyway, Exposed, and TransactionRunner. Use when repository or adapter contracts need coverage; choose unit tests for pure logic and E2E tests for full app boot."
---
