...
description: "Use for Kotest integration tests with real adapters: repository/adapter tests, PostgresTestFixture, Flyway/Exposed, TransactionRunner, or /integration-tests. Prefer this over /tdd unless explicit red-green guidance is requested. Use /e2e-tests for app boot."
---
