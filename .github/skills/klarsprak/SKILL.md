...
- I denne kodebasen er `Dispatch`, `Decision`, `Delivery`, `Recipient`, `Foundation`, `Channel` og `Reference` tekniske kodeord og skal være på engelsk, mens domeneord som `Brukervarsel`, `Ledervarsel`, `DittSykefravaer` og `Brev` beholdes på norsk.
