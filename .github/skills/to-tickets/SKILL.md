---
name: to-tickets
description: Use only after the user explicitly selects To Tickets to break an approved plan or specification into tracer-bullet tickets with explicit native blocking edges.
---
...
Start only after the user has explicitly selected `/to-tickets` in the current
...
After authorization, publish one issue per ticket in dependency order
...
Read the created tickets and native relationships back after writing. Report a
