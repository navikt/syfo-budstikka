...
- `.grill/CONTEXT.md` — valgt tilnærming, så skillen bruker samme vokabular.
- `.grill/adr/` — beslutninger skillen må respektere (ikke reåpne avgjorte valg).
- `.grill/GLOSSARY.md` — domenespråk skillen skal skrive i.
